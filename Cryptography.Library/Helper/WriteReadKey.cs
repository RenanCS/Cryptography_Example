...
namespace Cryptography.Library.Helper
{
    public class WriteReadKey
    {
        /// <summary>
        ...
        public static void GetPrivateKeyFromPemFile(string filePath, RSA csp)
        {
        ...
        public static void GetPublicKeyFromPemFile(String filePath, RSA csp)
        {
